...
This command is reported to block internet access of user so we just need to comment it out:

![](.images/openvpn-change-player-config.png)

Now let's create 2 more configs for team 1 and team 2:
