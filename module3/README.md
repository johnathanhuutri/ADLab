...
The file `docker-compose.yml` will build with context at folder `services`, neither folder `services/web1` nor folder `services/web2`. 
Here is an example of file `docker-compose.yml`:
